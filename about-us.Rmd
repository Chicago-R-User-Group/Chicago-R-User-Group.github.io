...
```{r echo=FALSE}
crug_df <- data.frame(Organizer = c('<h4> Anne Corinne Carroll</h4>','<h4> Charlotte Frei, PhD</h4>',     '<h4>Parfait Gasana</h4>', '<h4>Adam Ginensky, PhD</h4>','<h4>Troy Hernandez, PhD</h4>','<h4>Justin M Shea</h4>'),
